...
func ExampleHelmClient_AddOrUpdateChartRepo_krateo() {
...
func ExampleHelmClient_AddOrUpdateChartRepo_loft() {
	// Define a public chart repository.
	chartRepo := repo.Entry{
		Name: "loft-sh",
...
func ExampleHelmClient_InstallOrUpgradeChart_vcluster() {
